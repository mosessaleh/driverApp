...
export const getStyles = (isDarkMode: boolean, isRTL = false, isScheduledOffer = false) => {
  ...
  return StyleSheet.create({
    ...
    rideProposalDistanceLabel: {
      color: '#fff',
      fontSize: 13,
      fontWeight: '600',
    },
    rideProposalDistanceValue: {
      color: '#fff',
      fontSize: 16,
      fontWeight: '800',
    },
    ...
    openRidesCard: {
      ...
      marginBottom: 16,
      borderWidth: 1,
      borderColor: isDarkMode ? 'rgba(255,255,255,0.15)' : 'rgba(13,148,136,0.4)',
    },
    openRidesHeader: {
      flexDirection: 'row',
      alignItems: 'center',
    ...
    upcomingCardEmpty: {
      backgroundColor: isDarkMode ? 'rgba(148,163,184,0.06)' : '#f8fafc',
