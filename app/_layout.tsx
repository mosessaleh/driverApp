...
} from '../src/features/notificationRouting';
import '../src/i18n';

const navigateFromNotificationPayload = (payload: DriverNotificationPayload) => {
  const targetScreen = resolveNotificationScreen(payload);
  const target = getNavigationTarget(targetScreen, payload);
